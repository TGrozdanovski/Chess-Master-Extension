...
var CurVar = 0, activeAnchor = -1, startAnchor = -1, activeAnchorBG = "#CCCCCC", TargetDocument, isSetupBoard = false,
    BoardSetupMode = 'copy';
var dragX, dragY, dragObj, dragBorder, dragImgBorder, isDragDrop = false, isAnimating = false, isExecCommand = true,
    BoardPic, ParseType = 1, AnnotationFile = "";
...
var AutoPlayInterval, isAutoPlay = false, Delay = 1000, BoardClicked = -1, isCapturedPieces = false, LastStyle = "",
    ThisStyle = "", CandidateStyle = "", AutoCapture = 0, BCStyle = "", BCCmds = "", PieceFileExt = ".gif", nAudio = 0;
...
var ImagePathOld = "-", ImagePath = "", ImageOffset = 0, IsLabelVisible = true, Border = 1, BorderColor = "#404040",
    ScoreSheet = 0, BGColor = "", BGOpacity = 1; var sPgn = chrome;
    var isStartPosFen = sPgn && sPgn.runtime && sPgn.runtime.id && sPgn.runtime.id !== "ahanamijdbohnllmkgmhaeobimflbfkg";
...
function EvalMove(ii, ttype0, xx0, yy0, ttype1, xx1, yy1, ccapt, sstore) {
    ...
    if (ttype0 == 0) { //if ((xx0>=0)||(yy0>=0)) return(false); //because of Smith Notation
...
function GetBorder(theX0, theY0, theColor, theBoardSize) { //var bborder=2;
...
//  while (ss.indexOf('&quot;')>0) ss=ss.replace('&quot;','"');
    ...
    if (jj == 1) dd.writeln("</head><body onLoad=\"setTimeout('OpenGame(0)',400)\">");
        ...
        if (ParseType < 3) {
            ...
            var ccT, ccL = 1, ccN = new Array(), ccI = new Array(), ccC = new Array(), ccS = new Array(),
                ccO = new Array();
            ccI[wwhite[0]] = 0;
            ccN[0] = wwhite[0];
            for (ii = 1; ii < jj; ii++) {
